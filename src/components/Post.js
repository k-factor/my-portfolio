...
export default function Post(){
    ...
    return (
        <main className="bg-green-100 min-h-screeen p-12">
            <section>
                ...
                <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <span className="block h-64 relative rounded shadow leading-sung bg-white border-l-8 border-green-400 " key={index}>
                            <img
